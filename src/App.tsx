...
// 	// 			return { ...launch, missions };
// 	// 		});	
// 	// 		const allData = normalizedData.map( e => e.description)
// 	// 		console.log('dane', normalizedData);
// 	// 		console.log('opis', allData)
// 	// 	}
...
// 					<LoadingIcon />
// 				) : (
// 					normalizedData.map(({ launch_date_utc, mission_name, missions }) => (
// 						<Body
